...
const WeatherCard = () => {
  return (
    <div className="w-4/5 h-4/5 mx-auto rounded-3xl bg-white overflow-hidden shadow-2xl shadow-blue-800 grid grid-cols-6 grid-rows-6 gap-4">
      <div
        className="col-span-2 row-span-6 m-6 border-8 rounded-3xl relative"
        style={{
          background:
